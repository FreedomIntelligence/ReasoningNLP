...
2. **Chain of Thought Prompting Elicits Reasoning in Large Language Models** arXiv (2022)
   ...
   *Jason Wei, Xuezhi Wang, Dale Schuurmans, Maarten Bosma, Brian Ichter, Fei Xia, Ed Chi, Quoc Le, Denny Zhou* [[pdf](https://arxiv.org/pdf/2201.11903.pdf)]
...
6. **Large Language Models are Zero-Shot Reasoners** arXiv (2022)
   ...
   *Takeshi Kojima, Shixiang Shane Gu, Machel Reid, Yutaka Matsuo, Yusuke Iwasawa* [[pdf](https://arxiv.org/pdf/2205.11916.pdf)]
